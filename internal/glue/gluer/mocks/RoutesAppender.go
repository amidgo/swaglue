...
func (_m *RoutesAppender) AppendRoutes(routes []*model.Route) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func([]*model.Route) error); ok {
		r0 = rf(routes)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *RoutesAppender_AppendRoutes_Call) Run(run func(routes []*model.Route)) *RoutesAppender_AppendRoutes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]*model.Route))
	})
	return _c
}
...
func (_c *RoutesAppender_AppendRoutes_Call) RunAndReturn(run func([]*model.Route) error) *RoutesAppender_AppendRoutes_Call {
	_c.Call.Return(run)
	return _c
}
