...
func (_m *RoutesParser) Routes() []route.Route {
	ret := _m.Called()
...
func (_c *RoutesParser_Routes_Call) Return(_a0 []route.Route) *RoutesParser_Routes_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RoutesParser_Routes_Call) RunAndReturn(run func() []route.Route) *RoutesParser_Routes_Call {
	_c.Call.Return(run)
	return _c
}
